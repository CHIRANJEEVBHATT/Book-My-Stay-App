 ...
 * to represent different room types in a hotel booking system.
 *
 * @author Chiranjeev
 * @version 2.1
 */
...
/**
 * Abstract Room class representing the common structure
 * shared by all types of rooms in the hotel.
 */
abstract class Room {
